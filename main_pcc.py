...
# 打開一個 CSV 檔案，進行寫入操作
with open('unformal_pcc_accuracy_output.csv', 'w', newline='') as csvfile:
...
data_name.to_csv('unformal_pcc_data_name.txt', index=False, encoding='utf-8')
# 計算總準確率
...
with open('unformal_accuracy.txt', 'a') as file:
    file.write(f' Pearson 總準確率: {overall_accuracy:.2%}\n')